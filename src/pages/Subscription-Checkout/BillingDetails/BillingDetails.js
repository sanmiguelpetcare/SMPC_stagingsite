...
const BillingDetails = props => {
    const fields = props.fe_subscription_state.item.form.billing;
    const isSameAsShipping = props.fe_subscription_state.item.form.shippingSameBilling;
    ...
    return (
        <div className="form-content-container">
            <div className="same-checkbox">
                <div className="checkbox" onClick={ () => props.fe_subscription_actions.updateSameShippingBilling( !isSameAsShipping ) }>{ isSameAsShipping ? "Yes, same" : "Nooooo!" }</div>
...
export default ReduxConnect(BillingDetails, ["fe_subscription"]);